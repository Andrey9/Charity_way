...
Widget::register('widget__done', 'App\Widgets\Done\DoneWidget@index');

Widget::register('widget__product', 'App\Widgets\Product\ProductWidget@index');

Widget::register('widget__partner', 'App\Widgets\Partner\PartnerWidget@index');
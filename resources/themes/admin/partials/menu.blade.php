<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            @if ($user->hasAccess('partner.read'))
                <li class="{!! active_class('admin.partner*') !!}">
                    <a href="{!! route('admin.partner.index') !!}">
                        <i class="fa fa-group"></i>
                        <span>@lang('labels.partners')</span>

                        @if ($user->hasAccess('partner.create'))
                            <small class="label create-label pull-right bg-green" title="@lang('labels.add_partner')"
                                   data-href="{!! route('admin.partner.create') !!}">
                                <i class="fa fa-plus"></i>
                            </small>
                        @endif
                    </a>
            ...
            @if ($user->hasAccess('done.read'))
                <li class="{!! active_class('admin.done*') !!}">
                    <a href="{!! route('admin.done.index') !!}">
                        <i class="fa fa-check-square-o"></i>
                        <span>@lang('labels.done')</span>

                        @if ($user->hasAccess('partner.done'))
                            <small class="label create-label pull-right bg-green" title="@lang('labels.add_done')"
                                   data-href="{!! route('admin.done.create') !!}">
                                <i class="fa fa-plus"></i>
                            </small>
                        @endif
                    </a>

...
<div class="form-group @if ($errors->has('task_image')) has-error @endif">
    {!! Form::label('task_image', trans('labels.task'), ['class' => 'control-label col-xs-4 col-sm-3 col-md-2']) !!}

    <div class="col-xs-12 col-sm-7 col-md-4">
        {!! Form::imageInput('task_image', $model->task_image) !!}

        {!! $errors->first('task_image', '<p class="help-block error">:message</p>') !!}
    </div>
</div>

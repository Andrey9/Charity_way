...
<div class="form-group @if ($errors->has('category_id')) has-error @endif">
    {!! Form::label('category_id', trans('labels.category_id'), ['class' => 'control-label col-xs-4 col-sm-3 col-md-2']) !!}

    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
        {!! Form::select('category_id', $categories, $model->category_id ?:null, array('class' => 'form-control select2 input-sm', 'aria-hidden' => 'true')) !!}

        {!! $errors->first('category_id', '<p class="help-block error">:message</p>') !!}
    </div>
</div>

<div class="form-group required @if ($errors->has('volume')) has-error @endif">
    {!! Form::label('volume', trans('labels.volume'), ['class' => 'control-label col-xs-4 col-sm-3 col-md-2']) !!}

    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
        {!! Form::number('volume', $model->volume ?:null, ['placeholder' => trans('labels.volume'), 'required' => true, 'class' => 'form-control input-sm']) !!}

        {!! $errors->first('volume', '<p class="help-block error">:message</p>') !!}
    </div>
</div>
